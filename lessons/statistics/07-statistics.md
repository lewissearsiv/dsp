...
>> We are given the fact that elvis had a twin brother. We start with the probabilities of the following intersections:
>> P(Identical Twin \bigcap Boy) = 1/300 * 1/2 = 1/600
>> P(Fraternal Twin \bigcap Boy) = 1/125 * 1/4 = 1/500
>> Now we can calculate the the conditional probability:
>> P(Identical Twin | Twin Brother) = P(Identical Twin \bigcap Boy)/(P(Identical Twin \bigcap Boy)+P(Fraternal Twin \bigcap Boy)) = 5/11.
